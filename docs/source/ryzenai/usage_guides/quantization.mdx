...
Below you will find an easy end-to-end example on how to quantize VGG model from [Timm](https://huggingface.co/docs/timm/index).
...
```python
    ...
    export_dir = "/path/to/exported/onnx/model"
    quantization_dir = "/path/to/quantized/model"
