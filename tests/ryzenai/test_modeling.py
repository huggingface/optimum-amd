...
from testing_utils import RYZEN_PRETRAINED_MODEL_IMAGE_CLASSIFICATION, RYZEN_PRETRAINED_MODEL_OBJECT_DETECTION

from optimum.amd.ryzenai import RyzenAIModelForImageClassification, RyzenAIModelForObjectDetection
    ...
    def test_model(self, model_id):
        ...
        def run(model_id, file_name, ort_input, use_cpu_runner, compile_reserve_const_data):
            ...
            model = RyzenAIModelForImageClassification.from_pretrained(
                model_id, file_name=file_name, vaip_config=".\\vaip_config.json", provider="CPUExecutionProvider"
            )
